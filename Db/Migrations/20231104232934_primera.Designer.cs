...
namespace Db.Migrations
{
    ...
    [Migration("20231104232934_primera")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Db.Modelo.Autores", b =>
                {
            ...
            modelBuilder.Entity("Db.Modelo.Colecciones", b =>
                {
            ...
            modelBuilder.Entity("Db.Modelo.Editoriales", b =>
                {
            ...
            modelBuilder.Entity("Db.Modelo.Estamos_Prestamo", b =>
                {
            ...
            modelBuilder.Entity("Db.Modelo.Generos", b =>
                {
            ...
            modelBuilder.Entity("Db.Modelo.Libros", b =>
                {
            ...
            modelBuilder.Entity("Db.Modelo.Prestamos", b =>
                {
            ...
            modelBuilder.Entity("AutoresLibros", b =>
                {
                    b.HasOne("Db.Modelo.Autores", null)
                        .WithMany()
                        .HasForeignKey("Autoresid_autor")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Db.Modelo.Libros", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Db.Modelo.Libros", b =>
                {
                    b.HasOne("Db.Modelo.Colecciones", "Colecciones")
                        .WithMany()
                        .HasForeignKey("id_coleccion")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Db.Modelo.Editoriales", "Editoriales")
                        .WithMany("Libros")
                        .HasForeignKey("id_editorial")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Db.Modelo.Generos", "Generos")
                        .WithMany()
            ...
            modelBuilder.Entity("Db.Modelo.Prestamos", b =>
                {
                    b.HasOne("Db.Modelo.Estamos_Prestamo", "estado")
                        .WithMany()
            ...
            modelBuilder.Entity("LibrosPrestamos", b =>
                {
                    b.HasOne("Db.Modelo.Prestamos", null)
                        .WithMany()
